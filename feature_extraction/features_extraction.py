...
if __name__ == '__main__':
    ...
    bar = Bar("Processing data ...", max=len(data_files))
    for file in data_files:
        # skipping the feature extraction if it has already been done
        is_feature1_file = os.path.isfile("../../real_EEG_data/csv_features/features_per_recording_no_channel" + file)
        is_feature2_file = os.path.isfile("../../real_EEG_data/csv_features/features_per_channel" + file)
        if is_feature1_file and is_feature2_file:
            bar.next()
            continue
        ...
        try:
            ...
            array_features = [a, b, kurt, secdiffmean, secdiffmax, coef_variation, slopemean, slopevar, w1, w2, w3, w4,
                              w5,
                              w6,
                              w7, w8, welch1, welch2, welch3, welch4, power1, power2, power3, power4, ratio1, ratio2,
                              ratio3,
                              ratio4, spec_entropy]
            name_features = ['first_diff_mean', 'first_diff_max', 'kurtosis', 'sec_diff_mean', 'sec_diff_max',
                             'coef_variation',
            ...
            df.rename(
                index={0: 'first_diff_mean', 1: 'first_diff_max', 2: 'kurtosis', 3: 'sec_diff_mean', 4: 'sec_diff_max',
                       5: 'coef_variation', 6: 'slopemean', 7: 'slopevar', 8: 'w1', 9: 'w2', 10: 'w3', 11: 'w4',
                       12: 'w5',
                       13: 'w6', 14: 'w7', 15: 'w8', 16: 'welch1', 17: 'welch2', 18: 'welch3', 19: 'welch4',
                       20: 'power1',
            ...
            df2.rename(
                index={0: 'ch1', 1: 'ch2', 2: 'ch3', 3: 'ch4', 4: 'ch5', 5: 'ch6', 6: 'ch7', 7: 'ch8', 8: 'ch9',
                       9: 'ch10',
